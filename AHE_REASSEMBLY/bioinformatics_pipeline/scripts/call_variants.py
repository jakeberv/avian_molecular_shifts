...
def get_vcf(args, files, seq, dir):
	...
	vcf_out2 = os.path.join(dir, '%s.qual_filtered%s.vcf' % (args.lineage, args.qual))
	...
	# filter the sites
	subprocess.call("/usr/lib/jvm/java-8-openjdk-amd64/jre/bin/java -Xmx%sg -jar %s -T VariantFiltration -R %s -V %s "
