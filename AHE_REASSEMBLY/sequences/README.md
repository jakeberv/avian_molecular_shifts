...
/unaligned contains two files.
	locus-filtering.R is an R script used for data filtering after re-assembly
...
/aligned contains two directories
	/sample2haplo contains the full aligned datasets representing both reconstructed alleles from each taxon
	/sample1haplo contains the sub-sampled datasets used in the present set of analyses
